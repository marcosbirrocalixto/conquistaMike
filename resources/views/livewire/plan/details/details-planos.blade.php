<div class="p-5 bg-gray-100 border border-gray-300 rounded-md card">
    ...
    <p class="pb-2 font-semibold">Listagem de Detalhes do Plano: </p>
    <hr>
                        ...
                        <tr class="odd:bg-gray-200 even:bg-gray-100 p-2">
                            ...
                            <td class="w-2/12 text-right p-2">
                                <div class="flex justify-end gap-2">
                                          <!-- Botão Editar -->
                                    <a href="{{ route('detailsPlan.edit', $detail->id) }}" title="Alterar registro">
                                ...
                                <!-- Botão Excluir -->
                                <a href="{{ route('detailsPlan.delete', $detail->id) }}"  title="Excluir registro">
