<div class="container px-4 py-4 mx-auto">
    <div class="p-5 bg-gray-100 border border-gray-400 rounded-md card">
        <p class="pb-2 ml-1 font-semibold">Edição de Plano</p>
        <hr>

        <form class="w-full"  wire:submit.prevent="updatePlan">
            <!-- Nome -->
            ...
            <!-- E-mail -->
            <div class="flex items-center mb-6">
                <label class="w-1/6 pr-4 font-bold text-gray-500" for="email">Descrição</label>
                <div class="w-2/4">
                    <input class="w-full px-4 py-2 leading-tight text-gray-700 bg-gray-200 border rounded appearance-none focus:outline-none focus:bg-white" id="description" type="text" wire:model="description">
                    @error('description')
                        <span class="text-xs text-red-500">{{ $message }}</span>
                    @enderror
                </div>
