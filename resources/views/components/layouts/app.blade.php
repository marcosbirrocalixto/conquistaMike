    ...
    <script>
      function moneyMask() {
          return {
              ...
              formattedValue: '',
              formatMoney() {
                  let value = this.rawValue.replace(/\D/g, '');
                  value = (value / 100).toFixed(2) + '';
                  value = value.replace('.', ',');
                  value = value.replace(/\B(?=(\d{3})+(?!\d))/g, '.');
                  this.formattedValue = `R$ ${value}`;
              },
              init() {
                  this.$watch('formattedValue', value => {
      ...
      function timeMask() {
          return {
              ...
              formatTime() {
                  ...
                  this.formattedValue = value.substring(0, 5);
              }
          }
      }
  </script>
